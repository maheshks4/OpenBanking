angular
    .module('inspinia')
    .factory('OpenBankingService', OpenBankingService)
    .value('PageValues', {
        'title': null,
        'description': null,
        'loading': false,
        'obpkey': null
    }).constant('OBP_BASE_URL', 'https://socgen-k-api.openbankproject.com/obp/v2.2.0')

function OpenBankingService($http, $log, PageValues, OBP_BASE_URL) {
    var data = {
        'doAuth' : doAuth,
        'getBanks' : getBanks,
