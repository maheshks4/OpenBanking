 ...
 */
 function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    .state('dashboards.dashboard_obp', {
        url: "/dashboard_obp",
        templateUrl: "js/sections/dashboard/dashboard_obp.html",
        data: { pageTitle: 'Dashboard OBP' },
        controller: DashboardOBPController,
        resolve: {
            ...
            //,
            // auth: function(OpenBankingService, PageValues) {
            //     return OpenBankingService.doAuth().then(function(response){
